    ...
    return (
      <footer id="footer" className="bg-pink-100 text-gray-700 px-6 py-8 mt-6">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between gap-8">
          <div>
            <h4 className="text-xl font-semibold text-pink-700 mb-2">StoryHeaven</h4>
            <p className="text-sm">
              Delivering fresh and beautiful blooms right to your doorstep. Perfect for every occasion!
            </p>
            <img className="w-32 h-15" src="bookstore.png" alt="StoryHeaven Logo" />
          </div>
          ...
          <div>
            ...
            <p className="text-sm"><i class="fa-solid fa-phone"></i> +91 8712288069</p>
            <p className="text-sm"><i class="fa-solid fa-envelope"></i> support@storyheaven.com</p>
          </div>
        ...
        <div className="text-center text-sm text-gray-500 mt-8">
          © {new Date().getFullYear()} StoryHeaven. All rights reserved.
        </div>
      </footer>
    );
  }
